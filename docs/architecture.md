...
| `ml/` | Target generation (`target.py`, Phase 6), model training, walk-forward validation, ensemble | Phase 6-9 |
...
See `../README.md` for the full 16-phase list and current status.
